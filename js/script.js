...
// TODO: Добавить dagger после победы над слизнем, а хаммер после fanged monster.
// TODO: Добавить разброс урона.
const weapons = [
  {name: ' stick ', power: 5},
...
// TODO: correct locations[4] to get 1 button at the end.
// TODO: Придумать другой вызов пасхалки.
...
function buyHealth() {
  if (gold >= 10) {
    ...
    text.innerText ="You don't have enough gold! Go kill some monsters!"
  }
}

// TODO: Добавить кнопку после 1 приобретённого оружия
...
function attack() {
  ...
  healthText.innerText = health -= getMonsterAttackValue(monsters[fighting].level);
  if(isMonsterHit()) {
